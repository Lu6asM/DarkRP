...
public sealed partial class Player
{
	...
	void TryBuyLookedDoor()
	{
		...
		if ( !TryGetLookedRoleplayDoor( out var roleplayDoor ) )
		{
			Notices.SendNotice( Network.Owner, "block", Color.Red, "Regardez d'abord une porte roleplay.", 3 );
			return;
		}
	...
	void TrySetLookedDoorLockState( bool locked )
	{
		...
		{
			Notices.SendNotice( Network.Owner, "key", Color.Red, "Équipez d'abord vos clés.", 3 );
			return;
		}
