...
public sealed class CityLawManager : Component
{
	...
	public void RequestAddLaw( string lawText )
	{
		...
		{
			Notices.SendNotice( Rpc.Caller, "block", Color.Red, "Saisissez d'abord une loi.", 3 );
			return;
		}
		...
		Notices.SendNotice( Rpc.Caller, "gavel", Color.Green, "Loi municipale ajoutée.", 3 );
	...
	public void RequestRemoveLaw( int index )
	{
		...
		Notices.SendNotice( Rpc.Caller, "gavel", Color.Green, "Loi municipale supprimée.", 3 );
